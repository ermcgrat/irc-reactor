...
?>
 <input type="hidden" name="<?php echo $name; ?>" value="<?php echo htmlentities($data); ?>">
<?php
}
...
function InputCheckBox($name,$data, $def="", $val = "")
{
 ...
 FormatDefData($name,$data,$def);
?>
 <input type="checkbox" name="<?php echo $name; ?>" value="<?php echo $val; ?>" <?php if($val==$data){ echo "checked"; }?>>
<?php
}
...
function InputRadio($name,$data, $def = "", $val = "")
{
 ...
 FormatDefData($name,$data,$def);
?>
 <input type="radio" name="<?php echo $name; ?>" value="<?php echo $val; ?>" <?php if($val==$data){ echo "checked"; }?>>
<?php
}
...
function InputTextArea($name,$data,$def = "", $rows = 3, $cols = 20)
{
 FormatDefData($name,$data,$def);
?>
 <textarea rows="<?php echo $rows; ?>" name="<?php echo $name; ?>" cols="<?php echo $cols; ?>"><?php echo htmlentities($data); ?></textarea>
<?php
}
...
function InputText($name,$data,$def = "", $size = 20)
{
 FormatDefData($name,$data,$def);
?>
 <input type="text" name="<?php echo $name; ?>" size="<?php echo $size; ?>" value="<?php echo htmlentities($data); ?>">
<?php
}
...
function InputPassword($name,$data,$def = "", $size = 20)
{
 FormatDefData($name,$data,$def);
?>
 <input type="password" name="<?php echo $name; ?>" size="<?php echo $size; ?>" value="<?php echo htmlentities($data); ?>">
<?php
}
...
?>
 <input type="file" name="<?php echo $name; ?>" size="<?php echo $size; ?>" value="<?php echo htmlentities($data); ?>" <?php echo $accept; ?> >
<?php
}
...
<?php
 ...
 { ?>
   <option value="<?php echo $values[$k]; ?>" <?php if($values[$k]==$data){ echo "selected"; } ?>><?php echo $labels[$k]; ?></option>
 <?php } ?>
</select>
<?php
}
...
<?php
 while ($row = $res->fetch_assoc())
   {
    ?>
   <option value="<?php echo $row["value"]; ?>" <?php if($row["value"]==$data){ echo "selected"; } ?>><?php echo $row["label"]; ?></option>
    <?php
   }?>
</select>
<?php
...
?>
     <select NAME="<?php echo $fieldname; ?>[m]" size="1">
       <?php
      //======= FROM month ======
      for ($k=1;$k<=12;$k++)
      {
      ?>
        <option value="<?php echo $k; ?>" <?php if ($f[m] == $k) { echo "selected"; } ?>><?php echo $months[$k]; ?></option>
      <?php
      };
      //=====================
      ?>
      ...
      <select NAME="<?php echo $fieldname; ?>[d]" size="1">
      <?php
      //======= FROM Day ======
      for ($k=1;$k<=31;$k++)
      {
      ?>
        <option value="<?php echo $k; ?>" <?php if ($f[d] == $k) { echo "selected"; } ?>><?php echo $k; ?></option>
      <?php
      };
      //=====================
      ?>

      </select> <select NAME="<?php echo $fieldname; ?>[y]" size="1">
      ...
      {
      ?>
        <option value="<?php echo $k; ?>" <?php if ($f[y] == $k) { echo "selected"; } ?>><?php echo $k; ?></option>
      <?php
      };
      //=====================
      ?>
